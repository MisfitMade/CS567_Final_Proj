...
PATH_TO_RAW_BY_DAY_UPDATES = os.path.join(PATH_TO_RESOURCES, "by_day_updates")
PATH_TO_RAW_BY_YEAR_UPDATES = os.path.join(PATH_TO_RESOURCES, "by_year_updates")
PATH_TO_RAW_GAME_UPDATES = os.path.join(PATH_TO_RESOURCES, "game_updates")
PATH_TO_RAW_MISC_UPDATES = os.path.join(PATH_TO_RESOURCES, "misc_updates")
PATH_TO_RAW_NOISY_UPDATES = os.path.join(PATH_TO_RESOURCES, "noisy_updates")
